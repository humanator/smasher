...
import { NODE_DRAG_DATA_TYPE, NODE_KIND_CONFIG, PALETTE_GROUPS, THEME_COLORS } from '../../../src/components/node-editor/nodeConfig';
import type { NodeType } from '../../../src/components/node-editor/types';
